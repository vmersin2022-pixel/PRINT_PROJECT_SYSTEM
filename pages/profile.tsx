                ...
                <div className="bg-zinc-50 border border-black p-8 shadow-[8px_8px_0px_rgba(0,0,0,0.1)]">
                    ...
                    <div className="space-y-4 mb-8">
                        ...
                        <button 
                            ...
                            disabled={loading}
                            className="w-full bg-white border border-zinc-300 hover:border-black text-zinc-800 font-jura font-bold py-2 px-4 flex items-center justify-center gap-3 transition-all text-xs"
                        >
